...
public class NormalChatLogic extends AbstractChatLogic {
    ...
    private static final String PATTERN_2022 = "^.*002811CDCD0100......00581100........00" + Const.BASE_PATTERN + "00" + Const.BASE_PATTERN + "00.*$";

    /**
     * 正規表現オブジェクト.
     */
    private static Pattern pattern = Pattern.compile(PATTERN_2022);
